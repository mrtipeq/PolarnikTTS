...
Polish voice-over ("lektor") for YouTube subtitles: a Chrome extension that translates the
subtitles of the video you are watching into Polish and reads them with a high-quality,
selectable text-to-speech engine - local (GPU/CPU) or cloud - in sync with the video.
...
<p align="center">
  <img src="docs/screenshots/03_about.png" alt="About section" width="760">
</p>
